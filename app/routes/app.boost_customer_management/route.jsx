...
export default function BoostCustomerManagement() {
  ...
  useEffect(() => {
    if (user.shopify_code || user.token) {
      setIframeSrc(
        `${Iframe}customerTraffic?shopify_code=${user.shopify_code}&token=${user.token}`,
      );
    }
  ...
  return (
    <div className={styles.iframeContainer}>
      ...
      {iframeSrc && (
        <iframe
          src={iframeSrc}
          title="Boost No of Customer Management"
          width="100%"
          height="100%"
          style={{
